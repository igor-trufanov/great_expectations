...
| Validate           | [Run a Validation](/docs/cloud/validations/manage_validations.md#run-a-validation) through the Cloud UI                       | [Create a Validation Definition and run it](/core/run_validations) with the API                                                                                                                                                                                                                     |
